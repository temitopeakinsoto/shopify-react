...
export default function HomePage() {
    ...
    return (
        <Container>
            ...
            <Text>We are in process of launching a product/platform that allows you to acquire an asset (e.g e.g. laptops, PCs, projectors, CCTV, water dispenser, air-conditioner, TV, fridge and coffee machines) with a new payment term, i.e Rent per Month.</Text>
